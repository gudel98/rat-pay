class CreateSolidQueueTables < ActiveRecord::Migration[7.1]
  def change
    ...
    [
      ...
      ["solid_queue_claimed_executions", "solid_queue_jobs"],
      ["solid_queue_failed_executions", "solid_queue_jobs"],
      ["solid_queue_ready_executions", "solid_queue_jobs"],
      ["solid_queue_recurring_executions", "solid_queue_jobs"],
      ["solid_queue_scheduled_executions", "solid_queue_jobs"]
    ].each do |(from_table, to_table)|
      unless foreign_key_exists?(from_table, to_table, column: "job_id")
